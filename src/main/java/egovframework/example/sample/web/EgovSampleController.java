...
import egovframework.rte.fdl.excel.download.UsersVO;
...
public class EgovSampleController {
	...
	@RequestMapping(value = "/egovSampleListExcel.do")
	public ModelAndView selectSampleListExcel() throws Exception {
